...
**dash-penetration** is a web application security scanner for authorized penetration testing. It combines JavaScript rendering with vulnerability detection to test modern web applications.
