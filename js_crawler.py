        ...
        if inputs:
            ...
            for inp in inputs[:10]:
                ...
                if name or placeholder:
                    print(f"    → {name or 'unnamed'} [{type_attr}] {f'({placeholder})' if placeholder else ''}")
...
if __name__ == "__main__":
    import sys
    url = sys.argv[1] if len(sys.argv) > 1 else "https://edgar-treischl.pages.gitlab.lrz.de/dash-demo/"
